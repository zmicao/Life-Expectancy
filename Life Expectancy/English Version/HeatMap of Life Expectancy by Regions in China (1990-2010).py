...
def create_charts():
    ...
    geo_1 = Geo("HeatMap of Life Expectancy by Regions in China (1990-2010)", "China's Health Statistics Yearbook 2018", title_color="#000", title_pos="center",
    ...
    geo_4 = Geo("HeatMap of Life Expectancy by Regions in China (1990-2010)", "China's Health Statistics Yearbook 2018", title_color="#000", title_pos="center",
                width=1200, height=600)
    ...
    geo_7 = Geo("HeatMap of Life Expectancy by Regions in China (1990-2010)", "China's Health Statistics Yearbook 2018", title_color="#000", title_pos="center",
                width=1200, height=600)
    ...
    chart.add(geo_1, '1990')
    chart.add(geo_4, '2000')
    chart.add(geo_7, '2010')
    page.add(chart)
    ...
    geo_2 = Geo("HeatMap of Life Expectancy by Regions in China (1990-2010)", "China's Health Statistics Yearbook 2018", title_color="#000", title_pos="center",
                width=1200, height=600)
    ...
    geo_5 = Geo("HeatMap of Life Expectancy by Regions in China (1990-2010)", "China's Health Statistics Yearbook 2018", title_color="#000", title_pos="center",
                width=1200, height=600)
    ...
    geo_8 = Geo("HeatMap of Life Expectancy by Regions in China (1990-2010)", "China's Health Statistics Yearbook 2018", title_color="#000", title_pos="center",
                width=1200, height=600)
    ...
    chart.add(geo_2, '1990')
    chart.add(geo_5, '2000')
    chart.add(geo_8, '2010')
    page.add(chart)
    ...
    geo_3 = Geo("HeatMap of Life Expectancy by Regions in China (1990-2010)", "China's Health Statistics Yearbook 2018", title_color="#000", title_pos="center",
                width=1200, height=600)
    ...
    geo_6 = Geo("HeatMap of Life Expectancy by Regions in China (1990-2010)", "China's Health Statistics Yearbook 2018", title_color="#000", title_pos="center",
                width=1200, height=600)
    ...
    geo_9 = Geo("HeatMap of Life Expectancy by Regions in China (1990-2010)", "China's Health Statistics Yearbook 2018", title_color="#000", title_pos="center",
                width=1200, height=600)
    ...
    chart.add(geo_3, '1990')
    chart.add(geo_6, '2000')
    chart.add(geo_9, '2010')
    page.add(chart)
    return page

create_charts().render(path="./HeatMap of Life Expectancy by Regions in China (1990-2010).html")
