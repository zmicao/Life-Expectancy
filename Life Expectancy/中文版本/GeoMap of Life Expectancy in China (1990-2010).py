...
def create_charts():
    ...
    map_1 = Map("中国主要年份各地区预期寿命统计(1990-2010)", '平均值', width=1200, height=600)
    ...
    map_4 = Map("中国主要年份各地区预期寿命统计(1990-2010)", '平均值', width=1200, height=600)
    ...
    map_7 = Map("中国主要年份各地区预期寿命统计(1990-2010)", '平均值', width=1200, height=600)
    ...
    chart.add(map_1, '1990年')
    chart.add(map_4, '2000年')
    chart.add(map_7, '2010年')
    page.add(chart)
    ...
    map_2 = Map("中国主要年份各地区预期寿命统计(1990-2010)", '男性', width=1200, height=600)
    ...
    map_5 = Map("中国主要年份各地区预期寿命统计(1990-2010)", '男性', width=1200, height=600)
    ...
    map_8 = Map("中国主要年份各地区预期寿命统计(1990-2010)", '男性', width=1200, height=600)
    ...
    chart.add(map_2, '1990年')
    chart.add(map_5, '2000年')
    chart.add(map_8, '2010年')
    page.add(chart)
    ...
    map_3 = Map("中国主要年份各地区预期寿命统计(1990-2010)", '女性', width=1200, height=600)
    ...
    map_6 = Map("中国主要年份各地区预期寿命统计(1990-2010)", '女性', width=1200, height=600)
    ...
    map_9 = Map("中国主要年份各地区预期寿命统计(1990-2010)", '女性', width=1200, height=600)
    ...
    chart.add(map_3, '1990年')
    chart.add(map_6, '2000年')
    chart.add(map_9, '2010年')
    page.add(chart)
    return page

create_charts().render(path="./中国主要年份各地区预期寿命统计(1990-2010)地图.html")